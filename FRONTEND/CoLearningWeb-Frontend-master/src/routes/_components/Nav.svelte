	...
	<div class="container">
		...
		<ul class="nav navbar-nav pull-xs-right">
			{#if $session.user}
				...
				<li class="nav-item">
					<a rel='prefetch' href="/About" class="nav-link" class:active="{$page.path === '/About'}">
						About
					</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a rel='prefetch' href="/Change-Password" class="nav-link" class:active="{$page.path === '/Change-Password'}">
						Change Password
					</a>
				</li>
